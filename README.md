...
A simple and practical demonstration of building tool-calling AI agents using LangChain and Google Gemini.
...
📂 Project Structure
├── src/│   ├── LangchainFrameWork.py   # Basic agent demo with a simulated weather tool│   └── LangchainTask.py        # Math agent with add, multiply, divide, and square_root tools├── .env.example                # Template for your environment variables├── .gitignore├── requirements.txt└── README.md
🛠 Tech Stack
Python 3.10+
...
You need a Google Gemini API key to run this code. You can get one for free from Google AI Studio.
